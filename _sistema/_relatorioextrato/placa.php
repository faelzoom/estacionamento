...
<div class="" style="margin:-20px 20px 80px 20px;padding:100px;background-color:#fff;border-radius:10px">
	<div class="col form-group">
		<h2 class="display-4 text-center">Extrato por Placa</h2><br><br>
		
		<form action="?go=pesquisar" method="POST">
		<div class="row">
		<div class="col-4 form-group"></div>
		<div class="col-4 form-group">
		  <input type="text" name="pesquisar" id="pesquisar" class="form-control" placeholder="ABC-1020" required>
		</div>
    	...
    	<?php
		 ...
		 if(@$_GET['go']=='pesquisar'){
			...
			$subtotal1="SELECT total,SUM(total) as subtotal FROM pagamentos WHERE placa LIKE '%$pesquisar%'";
